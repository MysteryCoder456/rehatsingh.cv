...
import WhatsGoingOn from "@/components/whats-going-on";
          ...
          <Timeline>
            ...
            >
              <p>
                ...
                <b>do real things</b>, not just print text on a screen. Most of
                my first projects were remakes of games I enjoyed playing when I
                was younger.
              </p>
            </TimelineItem>
            ...
            >
              <p>
                As I learnt more about the world, my interests shifted. I began
                to view code as a facilitator for other fields, a tool to{" "}
                <b>amplify ideas</b> that exist outside the Computer Science
                sphere. This helped me explore fresh ideas that I previously
                would not have fully appreciated.
              </p>
            </TimelineItem>
            ...
            >
              <p>
                Over the years, I went from creating software purely for the
                sake of writing code to developing helpful products that solve
                real problems. Of course, I still enjoy the development journey
                and all the decisions that come with it, but my primary
                motivator is now the <b>value</b> my work brings to people.
              </p>
            ...
            >
              <div className="flex flex-row items-center">
                <ul className="list-outside ms-3.5">
                  ...
                  <li>
                    Assisted development of a legal chatbot using FastAPI,
                    React, and RAG, saving the legal team 8 hrs/wk
                  </li>
                  <li>
                    Partnered with the insurance department on an app for
                    vehicle inventory and insurance, handling data modeling and
